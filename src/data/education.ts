...
export const education: Education[] = [
  {
    ...
    description: 'Key project: AI-powered resume editor. Completed comprehensive coursework in computer science fundamentals, data structures, algorithms, software engineering, database management, computer networks, and artificial intelligence.',
  ...
  },
  {
    ...
    description: 'Completed higher secondary education with focus on computer science and mathematics. Participated in various technical competitions and coding events.',
  ...
  },
  {
    ...
    grade: '85%',
    location: 'West Bengal, India',
    description: 'Completed secondary education with excellent academic performance. Developed early interest in computer science and programming.',
