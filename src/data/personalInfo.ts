...
export const professionalSummary = {
  title: 'About Me',
  description: 'I, KOUSHIK Chandra Saha am Tech geek and Web Developer, worked as fast than others and managed any technical projects. I am passionate about creating innovative solutions using modern technologies and have extensive experience in full-stack development, data analytics, and cloud computing.',
  keyPoints: [
...
export const objectives = {
  ...
  description: 'To work with an organization with great enthusiasm and energy, where I can contribute my best and get an opportunity to learn and grow with the organization. I aim to leverage my technical skills and experience to drive innovation and deliver exceptional results.',
  goals: [
