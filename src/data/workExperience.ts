...
export const workExperience: WorkExperience[] = [
  {
    ...
    technologies: ['Python', 'Pandas', 'Power BI', 'Google Cloud Platform', 'BigQuery', 'AWS', 'Data Analysis', 'Machine Learning', 'SQL', 'Excel'],
  ...
  },
  {
    ...
    description: 'Worked on multiple full-stack development projects using MERN stack and other modern technologies. Gained hands-on experience in building scalable web applications and working in an agile development environment.',
    technologies: ['MongoDB', 'Express.js', 'React', 'Node.js', 'JavaScript', 'HTML', 'CSS', 'Git', 'REST APIs'],
  ...
  },
  {
    ...
    description: 'Created a college management software using PHP and MySQL. Developed and deployed the complete system with features for student management, course administration, and reporting. Worked closely with stakeholders to understand requirements and deliver solutions.',
    technologies: ['PHP', 'MySQL', 'HTML', 'CSS', 'JavaScript', 'Bootstrap', 'jQuery', 'Apache', 'Linux'],
